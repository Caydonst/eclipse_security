...
export default function BankAccountInfo({ vaultItem, copyToClipboard, open }: props) {
        ...
        <div className={styles.infoContainer}>
            ...
            <div className={styles.inputsContainer}>
                <div className={styles.openContainer}>
                    ...
                    <input id={"routingNumberInput"} type={"text"} value={vaultItem.routingNumber} readOnly={true} />
                </div>

                <div className={styles.hiddenContainer}>
                    <label htmlFor="accountNumberInput">Account Number</label>
                    <div className={styles.cardPasswordContainer}>
                        <input id={"accountNumberInput"} type={showAccountNumber ? "text" : "password"} value={vaultItem.accountNumber} readOnly={true} />
